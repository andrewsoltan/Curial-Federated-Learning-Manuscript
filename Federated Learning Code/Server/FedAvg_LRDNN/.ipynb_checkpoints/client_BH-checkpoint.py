...
port = "8002"
pauseTime = 5 #Set time pause to wait after completing LR and running DNN
    ...
    while relaunchOnCompletion == True:
        ...
        class LRClient(fl.client.NumPyClient):
            ...
            def evaluate(self, parameters, config):  # type: ignore
                ...
                """ Calculate variables for a VALIDATION ROC curve -- need to transmit to server """
        ...
        while not connected:
            try:
                ...
                print ('## Model 2: Deep Neural network.  Starting federated evaluation - awaiting server.')
