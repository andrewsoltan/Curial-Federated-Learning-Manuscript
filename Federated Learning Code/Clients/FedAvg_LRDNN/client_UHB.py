...
sslEnabled=True #can set False during testing
#hostName = "localhost"
port = "8002"
...
siteName = "UHB"
trainingOnly = True;
pathToTrainingData = "../raw/20210521 UHB CURIAL Dataset.csv"
pathToValidationData = ""
...
sys.path.insert(2, '..')
import preprocess_UHB as preprocessor
...
if __name__ == "__main__":
    ...
    ## UHB is a train-only dataset - therefore no split to give a validation cohort
    if trainingOnly:
        trainingDataset = preprocessedTrainingDataset
    elif not trainingOnly:
        #Perform Test/Validate split if not in same file, or alternatively, load in separate file and pre-process
        trainingDataset = preprocessedTrainingDataset
